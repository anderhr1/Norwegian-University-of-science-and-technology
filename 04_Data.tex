...
All the financial data is pulled from Factset. In addition to the Norwegian 10-years government bonds daily closing price, we pulled the following data for each stock:
\begin{itemize}
