...
\begin{minipage}{.5\textwidth}
  ...
  \captionof{figure}{Average Sign Ratio}
  \label{SignRatio}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
...
\begin{minipage}{.5\textwidth}
  ...
  \captionof{figure}{Average MAFE}
  \label{MAFE}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[scale=0.5]{Plot/EvaluationRMSE.png}
  \captionof{figure}{Average RMSE}
  \label{RMSE}
\end{minipage}
\end{figure}
...
This leads to two preliminary interpretations: the return forecasting performance for the one-day-ahead return in terms of predicting accuracy, precision and direction is worse for stocks with a high daily IVOL percentage. However, the return of trading according to the daily predictions of forecasting model tends to generate positive alpha for these stocks. Possible explanations for this result will be discussed in the next section.
